...
param vnetName = 'meme-iter1-vnet'
param vnetAddressPrefix = '10.0.6.0/23'
param subnets = [
  {
    name: 'meme-iter1-mgmt-subnet'
    addressPrefix: '10.0.6.0/28'
  }
  {
    name: 'meme-iter1-appgw-subnet'
    addressPrefix: '10.0.6.16/28'
  }
  {
    name: 'meme-iter1-ilb-subnet'
    addressPrefix: '10.0.6.32/28'
  }
  {
    name: 'meme-iter1-pe-subnet'
    addressPrefix: '10.0.6.64/26'
  }
  {
    name: 'meme-iter1-aks-subnet'
